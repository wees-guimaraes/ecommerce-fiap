...
public class Instantiation  implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Category category3 = new Category("Instrumentos");
        ...
        Address address1 = new Address("Rua Flores", "300", "C1","Vila Velha", "Liberdade","Uberlandia","38220834", customer1);
        Address address2 = new Address("Rua Senador Georgino", "647", "AP 224", "Itaquera", "São Paulo","São Paulo","08295370", customer2);
